...
<table>
  <tr>
    ...
    <td width="86%" valign="top">
      <h2>KOK</h2>
      <p><strong>어디서 볼지, 같이 가볍게 정하는 약속 장소 플래너.</strong></p>
      <p>
...
<table>
  <tr>
    ...
    <td width="86%" valign="top">
      ...
      <p><strong>이미지 기반 VQA 문제를 해결해 193팀 중 1위.</strong></p>
      <p>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>BBaru</h3>
      <p>목표 도착 시간에 맞춰 언제 출발해야 하는지 계산하는 ETA 기반 프로토타입.</p>
      <p><kbd>React</kbd> <kbd>Vite</kbd> <kbd>Tmap API</kbd></p>
      <p><a href="https://github.com/whtjddlr/BBaru">Repository</a></p>
    </td>
    <td width="50%" valign="top">
      <h3>CodeTree</h3>
      <p>문제 해결 감각을 유지하기 위한 알고리즘 풀이 아카이브.</p>
      <p><kbd>Python</kbd> <kbd>Algorithms</kbd></p>
      <p><a href="https://github.com/whtjddlr/CodeTree">Repository</a></p>
    </td>
  </tr>
</table>
